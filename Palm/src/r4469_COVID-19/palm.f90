...
! Former revisions:
! -----------------
! $Id: palm.f90 4457 2020-03-11 14:20:43Z raasch $
 ...
 PROGRAM palm
    ...
    USE control_parameters,                                                    &
        ONLY:  coupling_char, do2d_at_begin, do3d_at_begin, io_blocks,         &
               io_group, message_string, runnr, simulated_time_chr, spinup,    &
...
!-- Local variables
    ...
    version = 'PALM 6.0'
    user_interface_required_revision = 'r3703'
...
!-- Resetting of passive scalar after restart
    IF ( TRIM( initializing_actions ) == 'read_restart_data' )  THEN
       IF ( reset_scalar_in_restart )  THEN
          s(:,:,:) = 0.0_wp
       ENDIF
    ENDIF
!
